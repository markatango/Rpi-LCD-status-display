...
SPLASH_FINAL_SERVICE=final_lcd.service
...
sudo cp $SPLASH_FINAL_SERVICE $DEST
...
sudo systemctl enable $SPLASH_FINAL_SERVICE
sudo systemctl start $SPLASH_FINAL_SERVICE
