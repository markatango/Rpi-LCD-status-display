...
# tmc edit
# would you like the console to appear on the display? no
uninstall_console || bail "Unable to configure console"
# would you like the hdmi display to mirror to the pitft? yes
...
#~~ tmc edit - the below block is original. the above block is mine. ~~~
